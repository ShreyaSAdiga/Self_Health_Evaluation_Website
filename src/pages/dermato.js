...
return (
    <div style={{backgroundImage:`url(${hosp11})`,backgroundSize:"cover",backgroundRepeat:"no-repeat",width:"100%",height:"100vh",textAlign:"center"}}>
        ...
        <h1 style={style2}><br/><br/>Looking at the symptoms you have selected, <br/>it seems that you might be having a skin disease.<br/><br/>Do connect with the doctor by clicking the link below<br/></h1><br/>
        <a href="https://www.practo.com/bangalore/dermatologist" target="blank"><i class="fa fa-user-md" style={{color:"white",fontSize:"80px",border:"10px",padding:"10px",textAlign:"center",width:"100%"}}></i></a>
